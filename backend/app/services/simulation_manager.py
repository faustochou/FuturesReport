...
logger = get_logger('futuresreport.simulation')
...
class SimulationState:
    ...
    # 扩展：持久阶段 + checkpoint 支持（用于 resumability 和状态轮询）
    phase: str = "created"   # created | preparing | ready | simulating | simulating_round_X | completed | failed
    progress_percent: int = 0
    last_checkpoint_round: int = 0
    checkpoint_at: Optional[str] = None
    agent_count: int = 0   # 实际/预期 agent 数，用于前端警告
...
class SimulationManager:
    ...
    def _load_simulation_state(self, simulation_id: str) -> Optional[SimulationState]:
        ...
        state = SimulationState(
            ...
            agent_count=data.get("agent_count", data.get("entities_count", 0)),
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. 激活conda环境: conda activate futuresreport\n"
